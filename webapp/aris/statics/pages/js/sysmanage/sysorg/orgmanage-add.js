...
saveDocTag = function () {
    ...
    $.ajax({
        type: "POST",
        async: true,
        url: GLOBAL.WEBROOT + "/sysOrg/saveAddSysOrg.ajax?province="+province+"&city="+city+"&county="+county+"&town="+town+"&village="+village,
        dataType: 'json',
        ...
        success: function (data) {
            if (data.result == "0") {
                ...
                parent.updateOrgTreeOnSelectedNode(data.id, data.name);
               /* parent.initOrgTree();*/
                parent.doQuery();
