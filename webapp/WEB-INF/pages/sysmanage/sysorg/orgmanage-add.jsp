...
<head>
    ...
    <script type="text/javascript" src="${ctx}/aris/statics/pages/js/sysmanage/sysorg/orgmanage-add.js"></script>
    ...
    <div class="q_r_list">
        <div class="listTable">
            <form id="addForm" ame="addForm" action="#">
                ...
                <input type="hidden" id="provinceValue" value="${provinceValue1}"/>
                <input type="hidden" id="cityValue" value="${cityValue1}"/>
                <input type="hidden" id="parentOrgId" name="parentOrgId" value="${bean.parentOrgId}" />
                <input type="hidden" id="orgLevel" name="orgLevel" value="${bean.orgLevel}" />
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="biaoge">
                    <tr>
                        ...
                        <td >
                            <input type="text" id="orgName" name="orgName" class="w150" />
                        </td>
                        <th>
                            机构代码<span style="colorred;">*</span>
                        </th>
                        <td >
                            <input type="text" id="orgCode" name="orgCode" class="w150" />
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td >
                            <input type="text" id="orgShort" name="orgShort" class="w150" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td  align="left">
                            <input type="text" name="setupTime"  id="setupTime"  class="Wdate w150"  style="width:153px" onfocus="WdatePicker({dateFmt:'yyyy'})" />
                        </td>
                        <th>
                            机构唯一码
                        </th>
                        <td >
                            <input type="text" id="duns" name="duns"   onchange="checkDunsUID(0);" class="w150"/>
                        </td>
                    </tr>
                    <tr>
                        <th >
                        ...
                        <td  colspan="3" >
                            <select name="provinceCode" class="input-select" id="province1" style="margin-right:10px;" onkeyup="inOrgAddr()">
                                <option value=" ">--请选择--</option>
                            </select>
                            <select name="cityCode" class="input-select" id="city1" style="margin-right:10px;" onkeyup="inOrgAddr()">
                                <option value=" " >--请选择--</option>
                            </select>
                            <select name="districtCode" class="input-select" id="county1" style="margin-right:10px;" onkeyup="inOrgAddr()">
                                <option value=" " >--请选择--</option>
                            </select>
                            <select name="streetCode"  class="input-select" id="town1" style="margin-right:10px;" onkeyup="inOrgAddr()">
                                <option value=" " >--请选择--</option>
                            </select>
                            <select name="villageCode" id="village1" class="input-select" onkeyup="inOrgAddr()">
                                <option value=" " >--请选择--</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td  colspan="3">
                            <input type="text" style="width:600px;" id="orgAddr" name="orgAddr" class="w150" />
                        </td>
                    </tr>
                    <tr>
                        <th >
                        ...
                        <td >
                            <input type="text" id="lawPersonName" name="lawPersonName" class="w150" />
                        </td>
                        <th >
                            负责人电话
                        </th>
                        <td >
                            <input type="text" id="lawPersonTel" name="lawPersonTel" class="w150" />
                        </td>
                    </tr>
                    <tr>
                        <th >
                        ...
                        <td >
                            <input type="text" id="faxNo" name="faxNo" class="w150" />
                        </td>
                        <th >
                            机构联系人
                        </th>
                        <td >
                            <input type="text" id="contactName" name="contactName" class="w150" />
                        </td>
                    </tr>
                    <tr>
                        <th >
                        ...
                        <td >
                            <input type="text" id="contactTel" name="contactTel" class="w150" />
                        </td>
                        <th>
                            是否分支机构
                        </th>
                    ...
                    <tr>
                        ...
                        <td >
                            <input type="text" id="postcode" name="postcode" class="w150" />
                        </td>
                        <th >
                            邮箱
                        </th>
                        <td >
                            <input type="text" id="email" name="email" class="w150" />
                        </td>
                    </tr>
                    <tr>
                        <th >
                        ...
                        <td >
                            <input type="text" id="webUrl" name="webUrl" class="w150" />
                        </td>
                        <th >
                            分类管理代码：
                        </th>
                        <td >
                            <select id="managementCode" name="managementCode" style="width: 150px;" cssClass="input-select" >
                                <c:forEach var="managementCodeBean" items="${searchModel.managementCodeBean}">
                                    <option value="${managementCodeBean.itemNo}"  >${managementCodeBean.itemName}</option>
                                </c:forEach>
                            </select>
                        </td>
                    </tr>
                        ...
                        <td >
                            <select id="economicTypeCode" name="economicTypeCode" style="width: 150px;" cssClass="input-select" >
                                <c:forEach var="economicTypeCodeBean" items="${searchModel.economicTypeCodeBean}">
                                    <option value="${economicTypeCodeBean.itemNo}" >${economicTypeCodeBean.itemName}</option>
                                </c:forEach>
                            </select>
                        </td>
                        <th >
                        ...
                        <td >
                            <select id="organizerTypeCode" name="organizerTypeCode" style="width: 150px;" cssClass="input-select" >
                                <c:forEach var="organizerTypeCodeBean" items="${searchModel.organizerTypeCodeBean}">
                                    <option value="${organizerTypeCodeBean.itemNo}"  >${organizerTypeCodeBean.itemName}</option>
                                </c:forEach>
                            </select>
                        </td>
                    </tr>
                        ...
                        <td>
                            <select id="orgTypeFirst" name="orgTypeFirst" style="width: 150px;" cssClass="input-select" >
                                <c:forEach var="orgTypeFirstList" items="${searchModel.orgTypeFirstList}">
                                    <option value="${orgTypeFirstList.itemNo}"  >${orgTypeFirstList.itemName}</option>
                                </c:forEach>
                            </select>
                        </td>
                        <th >
                        ...
                        <td>
                            <select id="orgTypeSecond" name="orgTypeSecond" style="width: 150px;" cssClass="input-select" >
                                <c:forEach var="orgTypeSecondList" items="${searchModel.orgTypeSecondList}">
                                    <option value="${orgTypeSecondList.itemNo}"  >${orgTypeSecondList.itemName}</option>
                                </c:forEach>
                            </select>
                        </td>
                    </tr>
                        ...
                        <td >
                            <select id="orgTypeThird" name="orgTypeThird" style="width: 150px;" cssClass="input-select" >
                                <c:forEach var="orgTypeThirdList" items="${searchModel.orgTypeThirdList}">
                                    <option value="${orgTypeThirdList.itemNo}"  >${orgTypeThirdList.itemName}</option>
                                </c:forEach>
                            </select>
                        </td>
                        <th >
                        ...
                        <td >
                            <select id="subordinateRelationshipCode" name="subordinateRelationshipCode" style="width: 150px;" cssClass="input-select" >
                                <c:forEach var="subordinateRelationshipCodeBean" items="${searchModel.subordinateRelationshipCodeBean}">
                                    <option value="${subordinateRelationshipCodeBean.itemNo}"  >${subordinateRelationshipCodeBean.itemName}</option>
                                </c:forEach>
                            </select>
                        </td>
                    </tr>
                        ...
                        <td >
                            <select id="orgClassLevel" name="orgClassLevel" style="width: 150px;" cssClass="input-select" >
                                <c:forEach var="orgClassLevelBean" items="${searchModel.orgClassLevelBean}">
                                    <option value="${orgClassLevelBean.itemNo}"  >${orgClassLevelBean.itemName}</option>
                                </c:forEach>
                            </select>
                        </td>
                        <th >
                        ...
                        <td >
                            <select id="orgClassGrade" name="orgClassGrade" style="width: 150px;" cssClass="input-select" >
                                <c:forEach var="orgClassGradeBean" items="${searchModel.orgClassGradeBean}">
                                    <option value="${orgClassGradeBean.itemNo}"  >${orgClassGradeBean.itemName}</option>
                                </c:forEach>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td >
                            <input type="text" id="orgHead" name="orgHead" class="w150" />
                        </td>
                        <th >
                            代表人电话：
                        </th>
                        <td >
                            <input type="text" id="orgHeadTelephone" name="orgHeadTelephone" class="w150" />
                        </td>
                    </tr>
                    <tr>
                        <th >
