...
<head>
    ...
    <script type="text/javascript" src="${ctx}/aris/statics/pages/js/sysmanage/sysstation/edit.js?_dc=${staticVersion}"></script>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12" style="padding:6px;">
                <form class="form-horizontal" role="form" id="editForm">
                    <div class="form-group">
                        <label class="col-xs-2 control-label no-padding-right"> 岗位编码： </label>
                        <div class="col-xs-4">
                            <input id="stationCode" name="stationCode" class="inputW150" />
                        </div>
                        <label class="col-xs-2 control-label no-padding-right"> 岗位名称： </label>

                        <div class="col-xs-4">
                            <input id="stationName" name="stationName" class="inputW150"/>
                        </div>
                    </div>
                    <div class="form-group">
