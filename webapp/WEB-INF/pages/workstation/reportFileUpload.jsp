...
<head>
    ...
    <script type="text/javascript" src="${ctx}/aris/statics/pages/js/workstation/reportFileUpload.js"></script>
                ...
                <form method="post" name="uploadTemplateForm" id="uploadTemplateForm" class="form-horizontal" onsubmit="return checkForm()" enctype="multipart/form-data">
                    ...
                    <table id="addbtnTr" width="100%" border="0" cellspacing="0" cellpadding="0">
                       ...
                       <%-- <tr>
                        ...
                        <c:forEach items="${aisReportUploadBean}" var="file">
                            <tr>
                                <td><a href="javascript:void(0)" onclick="fileDownLoad('${file.fileName}');return false;">${file.fileName}</a></td>
                                <td><input type="button" value="下载" onclick="fileDownLoad('${file.fileName}')"></td>
                                <td><input type="button" value="删除" onclick="fileDelete('${file.fileName}',this)"></td>
                            </tr>
                        </c:forEach>
                    </table>
                </form>
