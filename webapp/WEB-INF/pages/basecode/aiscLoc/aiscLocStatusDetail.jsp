...
<head>
    ...
    <script type="text/javascript" src="${ctx}/aris/statics/pages/js/basecode/aiscloc/aisclocstatusdetail.js"></script>
    
    <link rel="stylesheet" href="${ctx}/aris/statics/pages/css/multiselect2side/jquery.multiselect2side.css" type="text/css">
    <script type="text/javascript" src="${ctx}/aris/statics/common/js/multiselect2side/jquery.multiselect2sidelocstatus.js"></script>
</head>
 <body class="body">
 		...
 		<div class="listTable">
            <form id="searchFormSe" action="#">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
            		<td>
            			<div class="ms2side__header" style="width:248px"><span style="color:red;">*</span> 科室列表</div>
            			<select name="searchable3" id='loclist' multiple='multiple' style="width:250px;height:180px" onclick="postloaddata(this.options[this.selectedIndex].value);">
						</select>
            		</td>
            		<td colspan="7">
            			<select name="searchable" id='statuslist' multiple='multiple' >
						</select>
            		</td>
            	</tr>
                </table>
