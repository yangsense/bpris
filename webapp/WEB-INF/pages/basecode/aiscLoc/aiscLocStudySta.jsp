...
<head>
    ...
    <script type="text/javascript" src="${ctx}/aris/statics/pages/js/basecode/aiscloc/aisclocstudysta.js"></script>
</head>
<body>
<div class="wrap100 quickrecharge">
	...
	<!--查询条件 begin-->
            ...
            <form id="searchForm" action="#">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                   <!--  <tr>
                        ...
                        <td width="18%">
                            <select id="studyStatus" name="studyStatus" class="inputW160">
        ...
        <!--查询条件 end-->
		<div>
			<table id="studyStatuslist" width="100%" border="0" cellspacing="0" cellpadding="0">
		   
			</table>
			<div id="studyStatus_pager"></div>
		</div>
    </div>
</div>
