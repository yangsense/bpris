...
<head>
    ...
    <script type="text/javascript" src="${ctx}/aris/statics/pages/js/basecode/aiscordcat2loc/aiscordcat2loclist.js"></script>
...
<div class="wrap100 quickrecharge">
	...
	<!--查询条件 begin-->
        ...
        <!--查询条件 end-->
		<div>
			<table id="aiscordcat2loclist" width="100%" border="0" cellspacing="0" cellpadding="0">
