...
<head>
    ...
    <script type="text/javascript" src="${ctx}/aris/statics/pages/js/basecode/aiscloginloc/aiscloginloclist.js"></script>
</head>
<body>
<div class="wrap100 quickrecharge">
	...
	<!--查询条件 begin-->
            ...
            <form id="searchForm" action="#">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                   <!--  <tr>
                        ...
                        <th class="r" width="13%">操作员 ID：</th>
                        <td width="18%">
                        	<input id="operatorId" name="operatorId" class="inputW160"/>
                        </td>    
                    </tr> -->
                    <tr>
                    	<td>
        ...
        <!--查询条件 end-->
		<div>
			<table id="aiscloginloclist" width="100%" border="0" cellspacing="0" cellpadding="0">
		   
			</table>
			<div id="aiscloginloc_pager"></div>
		</div>
    </div>
</div>
