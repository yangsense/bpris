...
<head>
    ...
    <script type="text/javascript" src="${ctx}/aris/statics/pages/js/basecode/aiscequip/aiscequipmentlist.js"></script>
</head>
<body>
<div class="wrap100 quickrecharge">
	...
	<!--查询条件 begin-->
        <div class="listTable">
            <form id="searchForm" action="#">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                    	<th class="r" width="13%">设备代码：</th>
                        <td width="18%">
                            <input name="equipmentCode" id="equipmentCode" class="inputW160"/>
                        </td>                         
                        <th width="13%" class="r">设备名称：</th>
                        <td width="18%" colspan='3'>
                            <input name="equipmentDesc" id="equipmentDesc" class="inputW160"/>
                        </td> 
                    </tr> -->
                    <tr>
                    	<td>
        ...
        <!--查询条件 end-->
		<div>
			<table id="aiscequiplist" width="100%" border="0" cellspacing="0" cellpadding="0">
		   
			</table>
			<div id="aiscequip_pager"></div>
		</div>
    </div>
</div>
