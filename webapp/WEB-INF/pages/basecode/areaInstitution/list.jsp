...
<head>
    ...
    <script type="text/javascript" src="${ctx}/aris/statics/pages/js/basecode/aiscAreaInstitution/list.js"></script>
            ...
            <!-- <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <th colspan="3" class="r n_b_b">
                    	<a href="javascript:void(0)" onclick="importOrgToArea();" id="fbox_grid-table_search"
                           class="fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset btn btn-sm btn-primary"><span
                                class="icon-plus-sign"></span>导 入</a>
                        <a href="javascript:void(0)" onclick="reloadGrid();"
