...
<head>
    ...
    <script type="text/javascript" src="${ctx}/aris/statics/pages/js/statanalysis/medicalCaseWorkload.js"></script>
            ...
            <form id="searchForm" action="#">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">                     
                    <!-- <tr>                                             
                        ...
                        <th class="r" width="13%" style="padding: 0">报告医生 ：</th>
                        <td width="13%">
                            <select id="reportDoctorid" name="reportDoctorid" style="width:120px;">
                                <option value="-1">请选择医生</option>
                            </select> 
                        </td>
                        <th class="r" width="13%" style="padding: 0">审核医生 ：</th>
                        <td width="13%">
                            <select id="reportVerifydoctorid" name="reportVerifydoctorid" style="width:120px;">
                                <option value="-1">请选择医生</option>
                            </select> 
                        </td>                       
                    </tr>
                    <tr>                                             
                        <th width="10%" class="r">关键字：</th>
                        <td width="13%">
                            <input id="categories" name="categories" class="inputW160" />
                            
                        </td> 
                        <th width="10%" class="r">阴阳性：</th>
                        <td>                             
                           <select id="reportIspositive" name="reportIspositive" style="width:160px;">
                                <option value="-1">请选择</option>
                           </select> 
                        </td>    
                        <th class="r" width="10%">年龄段 ：</th>
                        <td width="13%">
                        ...
                        <td width="18%" colspan="2" align="right">
	                    	...
	                    	<a href="javascript:void(0)" onclick="exportMedicalCase()" 
