...
public class QryordsubcateINFBean extends DataContainer implements DataContainerInterface,IQryordsubcateINFValue{

  private static String  m_boName = "com.ai.aris.server.interfacereal.bean.QryordsubcateINF";
  ...
  public QryordsubcateINFBean() throws AIException{
      super(S_TYPE);
  }
