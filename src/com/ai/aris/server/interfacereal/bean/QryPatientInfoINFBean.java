...
public class QryPatientInfoINFBean extends DataContainer implements DataContainerInterface,IQryPatientInfoINFValue{

  private static String  m_boName = "com.ai.aris.server.interfacereal.bean.QryPatientInfoINF";
  ...
  public QryPatientInfoINFBean() throws AIException{
      super(S_TYPE);
  }
