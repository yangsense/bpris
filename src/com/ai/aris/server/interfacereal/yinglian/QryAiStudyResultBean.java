...
public class QryAiStudyResultBean extends DataContainer implements DataContainerInterface,IQryAiStudyResultValue{

  private static String  m_boName = "com.ai.aris.server.interfacereal.yinglian.QryAiStudyResult";
  ...
  public QryAiStudyResultBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initReportToarchive(long value){
     this.initProperty(S_ReportToarchive,new Long(value));
  }
  public  void setReportToarchive(long value){
     this.set(S_ReportToarchive,new Long(value));
  }
  ...
  public long getReportToarchive(){
        return DataType.getAsLong(this.get(S_ReportToarchive));
  
  }
  public long getReportToarchiveInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_ReportToarchive));
      }
