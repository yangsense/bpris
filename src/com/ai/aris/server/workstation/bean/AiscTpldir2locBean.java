...
public class AiscTpldir2locBean extends DataContainer implements DataContainerInterface,IAiscTpldir2locValue{

  private static String  m_boName = "com.ai.aris.server.workstation.bean.AiscTpldir2loc";
  ...
  public AiscTpldir2locBean() throws AIException{
      super(S_TYPE);
  }
