...
public class AisStudyReportHBean extends DataContainer implements DataContainerInterface,IAisStudyReportHValue{

  private static String  m_boName = "com.ai.aris.server.workstation.bean.AisStudyReportH";
  ...
  public AisStudyReportHBean() throws AIException{
      super(S_TYPE);
  }
