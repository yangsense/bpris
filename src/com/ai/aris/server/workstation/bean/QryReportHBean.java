...
public class QryReportHBean extends DataContainer implements DataContainerInterface,IQryReportHValue{

  private static String  m_boName = "com.ai.aris.server.workstation.bean.QryReportH";
  ...
  public QryReportHBean() throws AIException{
      super(S_TYPE);
  }
