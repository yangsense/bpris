...
public class QryStudyPatientBean extends DataContainer implements DataContainerInterface,IQryStudyPatientValue{

  private static String  m_boName = "com.ai.aris.server.workstation.bean.QryStudyPatient";
  ...
  public QryStudyPatientBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initBirthdate(String value){
     this.initProperty(S_Birthdate,value);
  }
  public  void setBirthdate(String value){
     this.set(S_Birthdate,value);
  }
  public  void setBirthdateNull(){
     this.set(S_Birthdate,null);
  }

  public String getBirthdate(){
       return DataType.getAsString(this.get(S_Birthdate));
  
  }
  public String getBirthdateInitialValue(){
        return DataType.getAsString(this.getOldObj(S_Birthdate));
      }
  ...
  public void initGender(String value){
     this.initProperty(S_Gender,value);
  }
  public  void setGender(String value){
     this.set(S_Gender,value);
  }
  ...
  public String getGender(){
       return DataType.getAsString(this.get(S_Gender));
  
  }
  public String getGenderInitialValue(){
        return DataType.getAsString(this.getOldObj(S_Gender));
      }
