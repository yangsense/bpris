...
public class QryStudyInfoListBean extends DataContainer implements DataContainerInterface,IQryStudyInfoListValue{

  private static String  m_boName = "com.ai.aris.server.workstation.bean.QryStudyInfoList";
  ...
  public final static  String S_OldPatientId = "OLD_PATIENT_ID";
  ...
  public QryStudyInfoListBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initReportVerifytime(Timestamp value){
     this.initProperty(S_ReportVerifytime,value);
  }
  public  void setReportVerifytime(Timestamp value){
  ...
  public Timestamp getReportVerifytime(){
        return DataType.getAsDateTime(this.get(S_ReportVerifytime));
  
  }
  public Timestamp getReportVerifytimeInitialValue(){
        return DataType.getAsDateTime(this.getOldObj(S_ReportVerifytime));
      }
  ...
  public void initOldPatientId(String value){
     this.initProperty(S_OldPatientId,value);
  }
  public  void setOldPatientId(String value){
     this.set(S_OldPatientId,value);
  }
  public  void setOldPatientIdNull(){
     this.set(S_OldPatientId,null);
  }

  public String getOldPatientId(){
       return DataType.getAsString(this.get(S_OldPatientId));
  
  }
  public String getOldPatientIdInitialValue(){
        return DataType.getAsString(this.getOldObj(S_OldPatientId));
      }
