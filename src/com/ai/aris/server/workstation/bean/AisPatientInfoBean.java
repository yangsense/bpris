...
public class AisPatientInfoBean extends DataContainer implements DataContainerInterface,IAisPatientInfoValue{

  private static String  m_boName = "com.ai.aris.server.workstation.bean.AisPatientInfo";
  ...
  public AisPatientInfoBean() throws AIException{
      super(S_TYPE);
  }
