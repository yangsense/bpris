...
public class QryStudyInfoBean extends DataContainer implements DataContainerInterface,IQryStudyInfoValue{

  private static String  m_boName = "com.ai.aris.server.statanalysis.bean.QryStudyInfo";
  ...
  public QryStudyInfoBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initStudyIsbed(long value){
     this.initProperty(S_StudyIsbed,new Long(value));
  }
  public  void setStudyIsbed(long value){
     this.set(S_StudyIsbed,new Long(value));
  }
  ...
  public long getStudyIsbed(){
        return DataType.getAsLong(this.get(S_StudyIsbed));
  
  }
  public long getStudyIsbedInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_StudyIsbed));
      }
  ...
  public void initPaymenttypeId(long value){
     this.initProperty(S_PaymenttypeId,new Long(value));
  }
  public  void setPaymenttypeId(long value){
     this.set(S_PaymenttypeId,new Long(value));
  }
  ...
  public long getPaymenttypeId(){
        return DataType.getAsLong(this.get(S_PaymenttypeId));
  
  }
  public long getPaymenttypeIdInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_PaymenttypeId));
      }
  ...
  public void initStudyDatetimeDesc(String value){
     this.initProperty(S_StudyDatetimeDesc,value);
  }
  public  void setStudyDatetimeDesc(String value){
     this.set(S_StudyDatetimeDesc,value);
  }
  public  void setStudyDatetimeDescNull(){
     this.set(S_StudyDatetimeDesc,null);
  }

  public String getStudyDatetimeDesc(){
       return DataType.getAsString(this.get(S_StudyDatetimeDesc));
  
  }
  public String getStudyDatetimeDescInitialValue(){
        return DataType.getAsString(this.getOldObj(S_StudyDatetimeDesc));
      }
  ...
  public void initStudyCheckoutfilm(long value){
     this.initProperty(S_StudyCheckoutfilm,new Long(value));
  }
  public  void setStudyCheckoutfilm(long value){
     this.set(S_StudyCheckoutfilm,new Long(value));
  }
  ...
  public long getStudyCheckoutfilm(){
        return DataType.getAsLong(this.get(S_StudyCheckoutfilm));
  
  }
  public long getStudyCheckoutfilmInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_StudyCheckoutfilm));
      }
  ...
  public void initStudyTotalfee(long value){
     this.initProperty(S_StudyTotalfee,new Long(value));
  }
  public  void setStudyTotalfee(long value){
     this.set(S_StudyTotalfee,new Long(value));
  }
  ...
  public long getStudyTotalfee(){
        return DataType.getAsLong(this.get(S_StudyTotalfee));
  
  }
  public long getStudyTotalfeeInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_StudyTotalfee));
      }
  ...
  public void initStudyFirstvisit(long value){
     this.initProperty(S_StudyFirstvisit,new Long(value));
  }
  public  void setStudyFirstvisit(long value){
     this.set(S_StudyFirstvisit,new Long(value));
  }
  ...
  public long getStudyFirstvisit(){
        return DataType.getAsLong(this.get(S_StudyFirstvisit));
  
  }
  public long getStudyFirstvisitInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_StudyFirstvisit));
      }
  ...
  public void initStudyFilmprinted(long value){
     this.initProperty(S_StudyFilmprinted,new Long(value));
  }
  public  void setStudyFilmprinted(long value){
     this.set(S_StudyFilmprinted,new Long(value));
  }
  ...
  public long getStudyFilmprinted(){
        return DataType.getAsLong(this.get(S_StudyFilmprinted));
  
  }
  public long getStudyFilmprintedInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_StudyFilmprinted));
      }
