...
public class AiscPatientCheckLocrpBean extends DataContainer implements DataContainerInterface,IAiscPatientCheckLocrpValue{

  private static String  m_boName = "com.ai.aris.server.statanalysis.bean.AiscPatientCheckLocrp";
  ...
  public AiscPatientCheckLocrpBean() throws AIException{
      super(S_TYPE);
  }
