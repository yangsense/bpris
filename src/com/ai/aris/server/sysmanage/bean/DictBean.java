...
public class DictBean extends DataContainer implements DataContainerInterface,IDictValue{

  private static String  m_boName = "com.ai.aris.server.sysmanage.bean.Dict";
  ...
  public DictBean() throws AIException {
      super(S_TYPE);
  }
