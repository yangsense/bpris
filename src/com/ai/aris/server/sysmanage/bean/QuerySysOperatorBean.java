...
public class QuerySysOperatorBean extends DataContainer implements DataContainerInterface,IQuerySysOperatorValue{

  private static String  m_boName = "com.ai.aris.server.sysmanage.bean.QuerySysOperator";
  ...
  public QuerySysOperatorBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initShowChangePswDate(String value){
     this.initProperty(S_ShowChangePswDate,value);
  }
  public  void setShowChangePswDate(String value){
     this.set(S_ShowChangePswDate,value);
  }
  public  void setShowChangePswDateNull(){
     this.set(S_ShowChangePswDate,null);
  }

  public String getShowChangePswDate(){
       return DataType.getAsString(this.get(S_ShowChangePswDate));
  
  }
  public String getShowChangePswDateInitialValue(){
        return DataType.getAsString(this.getOldObj(S_ShowChangePswDate));
      }
  ...
  public void initShowCreateDate(String value){
     this.initProperty(S_ShowCreateDate,value);
  }
  public  void setShowCreateDate(String value){
     this.set(S_ShowCreateDate,value);
  }
  public  void setShowCreateDateNull(){
     this.set(S_ShowCreateDate,null);
  }

  public String getShowCreateDate(){
       return DataType.getAsString(this.get(S_ShowCreateDate));
  
  }
  public String getShowCreateDateInitialValue(){
        return DataType.getAsString(this.getOldObj(S_ShowCreateDate));
      }
