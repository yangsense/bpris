...
public class SysStationBean extends DataContainer implements DataContainerInterface,ISysStationValue{

  private static String  m_boName = "com.ai.aris.server.sysmanage.bean.SysStation";
  ...
  public SysStationBean() throws AIException{
      super(S_TYPE);
  }
