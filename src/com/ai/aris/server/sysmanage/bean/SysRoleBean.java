...
public class SysRoleBean extends DataContainer implements DataContainerInterface,ISysRoleValue{

  private static String  m_boName = "com.ai.aris.server.sysmanage.bean.SysRole";
  ...
  public SysRoleBean() throws AIException{
      super(S_TYPE);
  }
