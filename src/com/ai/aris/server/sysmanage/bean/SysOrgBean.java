...
public class SysOrgBean extends DataContainer implements DataContainerInterface,ISysOrgValue{

  private static String  m_boName = "com.ai.aris.server.sysmanage.bean.SysOrg";
  ...
  public final static  String S_XnhDuns = "XNH_DUNS";
  ...
  public SysOrgBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initXnhDuns(String value){
     this.initProperty(S_XnhDuns,value);
  }
  public  void setXnhDuns(String value){
     this.set(S_XnhDuns,value);
  }
  public  void setXnhDunsNull(){
     this.set(S_XnhDuns,null);
  }

  public String getXnhDuns(){
       return DataType.getAsString(this.get(S_XnhDuns));
  
  }
  public String getXnhDunsInitialValue(){
        return DataType.getAsString(this.getOldObj(S_XnhDuns));
      }
  ...
  public void initHaspacs(int value){
     this.initProperty(S_Haspacs,new Integer(value));
  }
  public  void setHaspacs(int value){
     this.set(S_Haspacs,new Integer(value));
  }
  ...
  public int getHaspacs(){
        return DataType.getAsInt(this.get(S_Haspacs));
  
  }
  public int getHaspacsInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_Haspacs));
      }
