...
public class SysOperatorOfficeBean extends DataContainer implements DataContainerInterface,ISysOperatorOfficeValue{

  private static String  m_boName = "com.ai.aris.server.sysmanage.bean.SysOperatorOffice";
  ...
  public SysOperatorOfficeBean() throws AIException{
      super(S_TYPE);
  }
