...
public class QryCareProvBean extends DataContainer implements DataContainerInterface,IQryCareProvValue{

  private static String  m_boName = "com.ai.aris.server.basecode.bean.QryCareProv";
  ...
  public QryCareProvBean() throws AIException{
      super(S_TYPE);
  }
