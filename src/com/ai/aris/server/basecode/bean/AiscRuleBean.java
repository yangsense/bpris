...
public class AiscRuleBean extends DataContainer implements DataContainerInterface,IAiscRuleValue{

  private static String  m_boName = "com.ai.aris.server.basecode.bean.AiscRule";
  ...
  public AiscRuleBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initRuleType(int value){
     this.initProperty(S_RuleType,new Integer(value));
  }
  public  void setRuleType(int value){
     this.set(S_RuleType,new Integer(value));
  }
  ...
  public int getRuleType(){
        return DataType.getAsInt(this.get(S_RuleType));
  
  }
  public int getRuleTypeInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_RuleType));
      }
