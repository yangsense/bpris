...
public class QryConsultLocBean extends DataContainer implements DataContainerInterface,IQryConsultLocValue{

  private static String  m_boName = "com.ai.aris.server.basecode.bean.QryConsultLoc";
  ...
  public QryConsultLocBean() throws AIException{
      super(S_TYPE);
  }
