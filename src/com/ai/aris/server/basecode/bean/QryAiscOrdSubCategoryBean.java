...
public class QryAiscOrdSubCategoryBean extends DataContainer implements DataContainerInterface,IQryAiscOrdSubCategoryValue{

  private static String  m_boName = "com.ai.aris.server.basecode.bean.QryAiscOrdSubCategory";
  ...
  public QryAiscOrdSubCategoryBean() throws AIException{
      super(S_TYPE);
  }
