...
public class AiscBodyPartBean extends DataContainer implements DataContainerInterface,IAiscBodyPartValue{

  private static String  m_boName = "com.ai.aris.server.basecode.bean.AiscBodyPart";
  ...
  public AiscBodyPartBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initBodypartPidname(String value){
     this.initProperty(S_BodypartPidname,value);
  }
  public  void setBodypartPidname(String value){
     this.set(S_BodypartPidname,value);
  }
  public  void setBodypartPidnameNull(){
     this.set(S_BodypartPidname,null);
  }

  public String getBodypartPidname(){
       return DataType.getAsString(this.get(S_BodypartPidname));
  
  }
  public String getBodypartPidnameInitialValue(){
        return DataType.getAsString(this.getOldObj(S_BodypartPidname));
      }
