...
public class QryAiscOrdsubcateBean extends DataContainer implements DataContainerInterface,IQryAiscOrdsubcateValue{

  private static String  m_boName = "com.ai.aris.server.basecode.bean.QryAiscOrdsubcate";
  ...
  public QryAiscOrdsubcateBean() throws AIException{
      super(S_TYPE);
  }
