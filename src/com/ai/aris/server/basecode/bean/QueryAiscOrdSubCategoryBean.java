...
public class QueryAiscOrdSubCategoryBean extends DataContainer implements DataContainerInterface,IQueryAiscOrdSubCategoryValue{

  private static String  m_boName = "com.ai.aris.server.basecode.bean.QueryAiscOrdSubCategory";
  ...
  public QueryAiscOrdSubCategoryBean() throws AIException{
      super(S_TYPE);
  }
