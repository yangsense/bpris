...
public class QryBodyPartBean extends DataContainer implements DataContainerInterface,IQryBodyPartValue{

  private static String  m_boName = "com.ai.aris.server.basecode.bean.QryBodyPart";
  ...
  public QryBodyPartBean() throws AIException{
      super(S_TYPE);
  }
