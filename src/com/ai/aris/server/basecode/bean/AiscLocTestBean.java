...
public class AiscLocTestBean extends DataContainer implements DataContainerInterface,IAiscLocTestValue{

  private static String  m_boName = "com.ai.aris.server.basecode.bean.AiscLocTest";
  ...
  public AiscLocTestBean() throws AIException{
      super(S_TYPE);
  }
