...
public class QueryOrgSelectBean extends DataContainer implements DataContainerInterface,IQueryOrgSelectValue{

  private static String  m_boName = "com.ai.aris.server.basecode.bean.QueryOrgSelect";
  ...
  public QueryOrgSelectBean() throws AIException{
      super(S_TYPE);
  }
