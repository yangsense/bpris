...
public class AiscConorganizationBean extends DataContainer implements DataContainerInterface,IAiscConorganizationValue{

  private static String  m_boName = "com.ai.aris.server.basecode.bean.AiscConorganization";
  ...
  public AiscConorganizationBean() throws AIException{
      super(S_TYPE);
  }
