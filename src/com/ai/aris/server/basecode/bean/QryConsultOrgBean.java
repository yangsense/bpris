...
public class QryConsultOrgBean extends DataContainer implements DataContainerInterface,IQryConsultOrgValue{

  private static String  m_boName = "com.ai.aris.server.basecode.bean.QryConsultOrg";
  ...
  public QryConsultOrgBean() throws AIException{
      super(S_TYPE);
  }
