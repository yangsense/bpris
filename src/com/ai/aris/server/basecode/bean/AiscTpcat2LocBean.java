...
public class AiscTpcat2LocBean extends DataContainer implements DataContainerInterface,IAiscTpcat2LocValue{

  private static String  m_boName = "com.ai.aris.server.basecode.bean.AiscTpcat2Loc";
  ...
  public AiscTpcat2LocBean() throws AIException{
      super(S_TYPE);
  }
