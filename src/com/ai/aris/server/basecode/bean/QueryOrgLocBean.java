...
public class QueryOrgLocBean extends DataContainer implements DataContainerInterface,IQueryOrgLocValue{

  private static String  m_boName = "com.ai.aris.server.basecode.bean.QueryOrgLoc";
  ...
  public QueryOrgLocBean() throws AIException{
      super(S_TYPE);
  }
