...
public class AisPatientInfoHisBean extends DataContainer implements DataContainerInterface,IAisPatientInfoHisValue{

  private static String  m_boName = "com.ai.aris.server.basecode.bean.AisPatientInfoHis";
  ...
  public AisPatientInfoHisBean() throws AIException{
      super(S_TYPE);
  }
